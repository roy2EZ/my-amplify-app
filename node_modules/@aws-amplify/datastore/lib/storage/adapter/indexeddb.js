...
var IndexedDBAdapter = /** @class */ (function () {
    ...
    IndexedDBAdapter.prototype.batchSave = function (modelConstructor, items) {
        return __awaiter(this, void 0, void 0, function () {
            var result, storeName, txn, store, items_2, items_2_1, item, id, _deleted, index, key, e_11_1;
            var e_11, _a;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                    ...
                    case 2:
                        ...
                        _b.label = 3;
                    case 3:
                        if (!!items_2_1.done) return [3 /*break*/, 9];
                    ...
                    case 4:
                        key = _b.sent();
                        if (!!_deleted) return [3 /*break*/, 6];
                        result.push([item, key ? types_1.OpType.UPDATE : types_1.OpType.INSERT]);
                        return [4 /*yield*/, store.put(item, key)];
                    case 5:
                        _b.sent();
                        return [3 /*break*/, 8];
                    case 6:
                        result.push([item, types_1.OpType.DELETE]);
                        if (!key) return [3 /*break*/, 8];
                        return [4 /*yield*/, store.delete(key)];
                    case 7:
                        _b.sent();
                        _b.label = 8;
                    ...
                    case 11:
                        ...
                        return [7 /*endfinally*/];
                    case 12: return [4 /*yield*/, txn.done];
                    case 13:
                        _b.sent();
                        return [2 /*return*/, result];
                }
